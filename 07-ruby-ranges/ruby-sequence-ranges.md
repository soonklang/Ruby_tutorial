...
### ภาษา Java
Range เมธอดใน Java ใช้คลาส  IntStream (32 บิต) หรือ LongStream (64 บิต) ใช้พารามิเตอร์ของฟังก์ชันระบุช่วงลำดับ มี 2 พารามิเตอร์ คือ startInclusive(รวมค่าเริ่มต้น)  และ endExclusive (ไม่รวมค่าเริ่มต้น)
