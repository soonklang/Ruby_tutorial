...
ที่เงื่อนไข when เป็นรูปแบบ ค่า,ค่า เหมือนกับ หรือ เช่น case เป็นค่า "1" เมื่อนำไปตรวจกับเงื่อนไขพบว่าตรง กับเงื่อน ไข "1","2" เพราะ case ที่เป็น "1" ตรงกับค่าในเงื่อนไขที่เป็น "1" เช่นกัน ทำให้ output เป็น You order Espresso! เเต่หาก case ไม่ตรงกับเงื่อนไขใดเลย ก็จะได้ output ตาม เงื่อนไข else คือ No Order!
