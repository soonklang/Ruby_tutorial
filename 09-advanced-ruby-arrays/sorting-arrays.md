...
ก่อนจะเริ่มการเปรียบเทียบเนื่องจากภาษา c ไม่มีฟังก์ชันที่เกื้อหนุนกับการใช้ sorting array มากเท่าที่ควร เนื่องจากภาษา c เป็นภาษาระดับต่ำเป็นสาเหตุที่ทำให้ต้องเน้นในเรื่องของประสิทธิภาพและการควบคุมนหน่วยความจำที่ต้องจัดการเอง โดยทำให้มีแค่ฟังก์ชันแค่ qsort ทำให้ต้องมีการสร้าง ฟังก์ชั่นเปรียบเทียบเพื่อให้สามารถนำภาษา c มาเปรียบเทียบกับภาษา ruby ได้โดยตัวของ code สำหรับการใช้งานจะมีดังนี้
...
*เอกสารฉบับนี้จัดทำเพื่อใช้นำขึ้นบน GitHub เป็นไฟล์เดียว (README.md) โดยเก็บเนื้อหาและข้อมูลทั้งหมดตามที่ผู้ส่งมาโดยไม่ตัด/ลบ/เปลี่ยนสาระสำคัญ ยกเว้นการแปลงเครื่องหมาย `#` ตามหลังบรรทัดของโค้ดให้เป็นคอมเมนต์ที่ถูกต้องตามไวยากรณ์ภาษานั้นๆ เพื่อให้โค้ดในตัวอย่างสามารถอ่านและแสดงผลได้ชัดเจนมากขึ้น.*
