...
**Indentation** คือการจัดบรรทัดให้ข้อความขยับไปทางขวา เพื่อให้โค้ดดูเป็นระเบียบสวยงาม เวลาพิมพ์ heredoc บางทีเราอยากให้ข้อความใน heredoc ขยับไปตามโค้ดที่อยู่ข้างใน เราสามารถใช้ `<<-IDENTIFIER` หรือ `<<~IDENTIFIER` เพื่อให้ Ruby ตัดช่องว่าง (space) ข้างหน้าข้อความออกให้เอง
...
| ภาษา    | Syntax เฉพาะ | รองรับ Multiline | Interpolation | ความอ่านง่าย | หมายเหตุ |
|---------|--------------|------------------|---------------|--------------|----------|
| Ruby    | มี (<<)      | มี               | มี            | ดี           | Identifier กำหนดเอง |
| C       | ไม่มี        | มี (เชื่อมเอง)   | ไม่มี         | น้อย         | ต้องเชื่อม string |
| Java    | มี (""")     | มี               | ไม่มี         | ดี           | Java 15+ เท่านั้น |
| Python  | มี (""")     | มี               | มี (f-string) | ดี           | triple quote |
